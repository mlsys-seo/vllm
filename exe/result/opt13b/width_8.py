...
sampling_params = SamplingParams(n=8, best_of=8, presence_penalty=1.0, frequency_penalty=1.0, temperature=0.0, use_beam_search=True, early_stopping=True, max_tokens=256)
